...
public class LocaleFactory {
    ...
    private static final HashMap<String, LocalizableResource> cache = new HashMap<String, LocalizableResource>();
     ...
     * <p/>
     * On server side <em>current</em> locale is determined dynamically by {@link net.lightoze.gwt.i18n.server
     * .LocaleProvider} and can change in runtime for the same object.
     *
    ...
    /**
     * Get <em>encoding</em> localization object, which will encode all requests so that they can be decoded later by
     * {@link net.lightoze.gwt.i18n.server.LocaleProxy#decode}.
     * <p/>
     * The purpose is to separate complex (e.g. template-based) text generation and its localization for particular
     * locale into two separate phases.
     * <p/>
