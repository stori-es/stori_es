...
public class GQuery implements Lazy<GQuery, LazyGQuery> {
    ...
    private static class TagWrapper {
        ...
        private final String postWrap;
        private final String preWrap;
     ...
     */
    public static final Class<com.google.gwt.query.client.plugins.Effects> Effects = com.google.gwt.query.client.plugins
            .Effects.Effects;
     ...
     */
    public static final Class<com.google.gwt.query.client.plugins.Events> Events = com.google.gwt.query.client.plugins
            .Events.Events;

    /**
     * A static reference to the GQuery class.
     */
    public static final Class<GQuery> GQUERY = GQuery.class;
    ...
    private static final RegExp posRegex = RegExp
    ...
    private static final RegExp tagNameRegex = RegExp.compile("<([\\w:-]+)");

    /**
     * Static reference to the Widgets plugin.
     */
    public static Class<com.google.gwt.query.client.plugins.Widgets> Widgets = com.google.gwt.query.client.plugins
            .Widgets.Widgets;
    ...
    /**
     * Create a new GQuery given a list of {@link Node} or
     * {@link IsWidget}.
     */
    ...
    public static <T extends GQuery> T $(String selector, Node context, Class<T> plugin) {
        try {
            if (plugins != null) {
                return (T) plugins.get(plugin).init(new GQuery().select(selector, context));
            }
    ...
    public GQuery attr(String key, Function closure) {
        int i = 0;
        for (Element e : elements) {
            Object val = closure.f(e.<Element>cast(), i++);
            $(e).attr(key, val);
        }
        return this;
    }
    ...
    public GQuery attr(String key, Object value) {
        ...
        assert !"$H".equalsIgnoreCase(key) : "$H is a GWT reserved attribute. Changing its value will break your " +
                "application.";
    ...
    public GQuery clearQueue() {
        return as(QueuePlugin.Queue).clearQueue();
    }
    ...
    public GQuery clearQueue(String queueName) {
        return as(QueuePlugin.Queue).clearQueue(queueName);
    }
     ...
     * $("#foo").css(CSS.COLOR.with(RGBColor.RED)).delay(800).queue(lazy().css(CSS.COLOR.with(RGBColor.BLACK)).dequeue
     * ().done());
     * </pre>
     */
    public GQuery delay(int milliseconds, Function... f) {
        return as(QueuePlugin.Queue).delay(milliseconds, f);
    }
    ...
    public GQuery delay(int milliseconds, String queueName, Function... f) {
        return as(QueuePlugin.Queue).delay(milliseconds, queueName, f);
    }
    ...
    public GQuery dequeue() {
        return as(QueuePlugin.Queue).dequeue();
    }
    ...
    public GQuery dequeue(String queueName) {
        return as(QueuePlugin.Queue).dequeue(queueName);
    }
     ...
     */
    public com.google.gwt.query.client.plugins.Effects fadeToggle(int millisecs, Function... f) {
    ...
    public Promise promise() {
        return as(QueuePlugin.Queue).promise();
    }
    ...
    public Promise promise(String name) {
        return as(QueuePlugin.Queue).promise(name);
    }
    ...
    public <T> T prop(String key, Class<? extends T> clz) {
        assert key != null : "Key is null";
        return isEmpty() ? null : JsUtils.prop(get(0), key, clz);
    }
     ...
     *                {@linkplain Function#f(Element, int) passed} the target
     ...
     */
    public int queue() {
        return as(QueuePlugin.Queue).queue();
    }
    ...
    public GQuery queue(Function... f) {
        return as(QueuePlugin.Queue).queue(f);
    }
    ...
    public int queue(String queueName) {
        return as(QueuePlugin.Queue).queue(queueName);
    }
    ...
    public GQuery queue(String queueName, Function... f) {
        return as(QueuePlugin.Queue).queue(queueName, f);
    }
    ...
    public GQuery show() {
        for (Element e : elements) {
            ...
            if (oldDisplay == null && "none".equals(currentDisplay)) {
                getStyleImpl().setStyleProperty(e, "display", null);
                currentDisplay = "";
            }
     ...
     * completion.
     */
    public com.google.gwt.query.client.plugins.Effects slideDown(Function... f) {
     ...
     * completion.
     */
    public com.google.gwt.query.client.plugins.Effects slideDown(int millisecs, Function... f) {
     ...
     */
    public com.google.gwt.query.client.plugins.Effects slideToggle(Function... f) {
     ...
     * elements to be hidden or shown in a "sliding" manner
     */
    public com.google.gwt.query.client.plugins.Effects slideToggle(int millisecs, Function... f) {
     ...
     * completion.
     */
    public com.google.gwt.query.client.plugins.Effects slideUp(Function... f) {
     ...
     * completion.
     */
    public com.google.gwt.query.client.plugins.Effects slideUp(int millisecs, Function... f) {
    ...
    public GQuery stop(boolean clearQueue, boolean jumpToEnd) {
        return as(QueuePlugin.Queue).stop(clearQueue, jumpToEnd);
    }
