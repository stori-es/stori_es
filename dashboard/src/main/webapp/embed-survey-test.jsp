...
<head>
    ...
    <script type="text/javascript">
        ...
        var storiesConfig = {corsDomain: "127.0.0.1", corsPort: "8081"};
    </script>
    <script type="text/javascript" src="//localhost:8081/surveymvp/surveymvp.nocache.js"></script>
</head>
...
<div>
    ...
    <div id="survey" class="stories-questionnaire-share8" style="width: 600px; float: left;"></div>
