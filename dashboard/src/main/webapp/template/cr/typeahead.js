...
CUTypeAhead.init = function () {
    ...
    CUTypeAhead.addEvent(theSearchElement, 'keyup', CUTypeAhead.keyTrigger);
    /* if keydown, it won't use the current key in the comparison */
    CUTypeAhead.addEvent(theSearchElement, 'mouseover', CUTypeAhead.mouseTrigger);
    /* if we have already hidden the div by a mouseout, a mouseover will recover it */
