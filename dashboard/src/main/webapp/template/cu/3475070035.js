(function () {
    ...
    optly.Cleanse.finish = function () {
        if (optly.Cleanse.running) {
            ...
            if ((-1 !== window.location.hash.indexOf("optimizely_log=true") || -1 !== window.location.search.indexOf("optimizely_log=true")) && a && a.log)for (var b = optly.Cleanse.logs, d = 0; d < b.length; d++)a.log(b[d])
        }
    };
    ...
    var $ = function (r, m) {
            ...
            if (!(a.liveFired === this || !f || !f.live || a.target.disabled || a.button && "click" === a.type)) {
                ...
                for (k = e.length; j < k; j++) {
                    ...
                    for (i = 0; i < n.length; i++)if (f = n[i], m.selector === f.selector && (!l || l.test(f.namespace)) && !m.elem.disabled) {
                        ...
                        d.contains(h, g) && (g = h);
                        (!g || g !== h) && q.push({elem: h, handleObj: f, level: m.level})
                    }
                }
                j = 0;
        ...
        function Da(a, b) {
            ...
            if (1 === b.nodeType) {
                ...
                } else if ("option" === c) b.selected = a.defaultSelected; else if ("input" === c ||
        ...
        function qb(a, b) {
            b.src ? d.ajax({url: b.src, async: !1, dataType: "script"}) : d.globalEval((b.text || b.textContent ||
        ...
        k.extend = k.fn.extend = function () {
            ...
            i === h && (f = this, --h);
            for (; h < i; h++)if (null != (a = arguments[h]))for (b in a)c = f[b], g = a[b], f !== g && (j && g && (k.isPlainObject(g) || (d = k.isArray(g))) ? (d ? (d = !1, c = c && k.isArray(c) ? c : []) : c = c && k.isPlainObject(c) ? c : {}, f[b] = k.extend(j, c, g)) : g !== m && (f[b] = g));
            return f
        };
        k.extend({
            noConflict: function (a) {
                ...
                if (!S) {
                    ...
                    if (l.addEventListener) l.addEventListener("DOMContentLoaded", B, !1), r.addEventListener("load", k.ready, !1); else if (l.attachEvent) {
                ...
                if (c)if (h)for (g in a) {
                    if (!1 === b.apply(a[g],
                            c))break
                } else for (; d < f && !1 !== b.apply(a[d++], c);); else if (h)for (g in a) {
                ...
                var c = a.length, g = 0;
                if ("number" === typeof b.length)for (var d = b.length; g < d; g++)a[c++] = b[g]; else for (; b[g] !== m;)a[c++] = b[g++];
                a.length = c;
                return a
            }, grep: function (a, b, c) {
                ...
                if (a instanceof k || i !== m && "number" === typeof i && (0 < i && a[0] && a[i - 1] || 0 === i || k.isArray(a)))for (; h < i; h++)g = b(a[h], h, c), null !=
                g && (f[f.length] = g); else for (d in a)g = b(a[d], d, c), null != g && (f[f.length] = g);
                    ...
                    pipe: function (a, c) {
                        return d.Deferred(function (g) {
                            d.each({
                                    ...
                                    "resolve"], fail: [c, "reject"]
                            }, function (a, c) {
                                var f = c[0], e = c[1], k;
                                if (d.isFunction(f)) b[a](function () {
                                    if ((k = f.apply(this, arguments)) && d.isFunction(k.promise)) k.promise().then(g.resolve, g.reject); else g[e + "With"](this === b ? g : this, [k])
                                }); else b[a](g[e])
                            })
                        }).promise()
                    },
        ...
        if (!na || !na.length || !C) ma = {}; else {
            ...
            X = {visibility: "hidden", width: 0, height: 0, border: 0, margin: 0, background: "none"};
            J && d.extend(X, {
                position: "absolute",
            ...
            o.innerHTML = "";
            l.defaultView && l.defaultView.getComputedStyle && (D = l.createElement("div"), D.style.width = "0", D.style.marginRight = "0", o.appendChild(D), s.reliableMarginRight = 0 === (parseInt((l.defaultView.getComputedStyle(D, null) || {marginRight: 0}).marginRight, 10) || 0));
            x.innerHTML = "";
            W.removeChild(x);
        ...
        d.extend({
            _mark: function (a, b) {
                ...
                if (b) {
                    var c = c || "fx", g = c + "mark";
                    if (a = a ? 0 : (d.data(b, g, m, true) || 1) - 1) d.data(b, g, a, true); else {
        ...
        d.extend({
            ...
            attrHooks: {
                type: {
                    set: function (a, b) {
                        if (Pb.test(a.nodeName) && a.parentNode) d.error("type property can't be changed"); else if (!d.support.radioValue && b === "radio" && d.nodeName(a, "input")) {
                            var c = a.value;
                            a.setAttribute("type",
                                b);
                            if (c) a.value = c;
        ...
        d.event =
            {
                add: function (a, b, c, g) {
                    if (!(a.nodeType === 3 || a.nodeType === 8)) {
                        if (c === false) c = w; else if (!c)return;
                        var e, f;
                        if (c.handler) {
                            e = c;
                            c = e.handler
                        ...
                        if (f = d._data(a)) {
                            ...
                            for (var b = b.split(" "), j, k = 0, l; j = b[k++];) {
                                f = e ? d.extend({}, e) : {handler: c, data: g};
                                if (j.indexOf(".") > -1) {
                                    l = j.split(".");
                                    j = l.shift();
                                    f.namespace =
        ...
        d.Event.prototype = {
            ...
            }, isDefaultPrevented: w, isPropagationStopped: w, isImmediatePropagationStopped: w
        };
        var Ta = function (a) {
        ...
        if (!d.support.changeBubbles) {
            var L, Va = function (a) {
                ...
                if (b === "radio" || b === "checkbox") c = a.checked; else if (b === "select-multiple") c = a.selectedIndex > -1 ? d.map(a.options, function (a) {
                        return a.selected
                    }).join("-") : ""; else if (d.nodeName(a, "select")) c = a.selectedIndex;
                return c
            }, Z = function (a, b) {
                var c = a.target, g, e;
        ...
        d.each(["bind", "one"], function (a, b) {
            d.fn[b] = function (a, g, e) {
                ...
                if (a === "unload" && b !== "one") this.one(a, g, e); else {
                    h = 0;
        ...
        var qa = {focus: "focusin", blur: "focusout", mouseenter: "mouseover", mouseleave: "mouseout"};
        ...
        var n = function (a, b, c, d) {
            ...
            if (q.length > 1 && Ub.exec(a))if (q.length === 2 && p.relative[q[0]]) h = $a(q[0] + q[1], b); else for (h = p.relative[q[0]] ? [b] : n(q.shift(), b); q.length;) {
                a = q.shift();
            ...
            i || (i = h);
            i || n.error(k || a);
            if (Ya.call(i) === "[object Array]")if (m)if (b && b.nodeType === 1)for (a = 0; i[a] != null; a++)i[a] && (i[a] === true || i[a].nodeType === 1 && n.contains(b, i[a])) && c.push(h[a]); else for (a = 0; i[a] !=
            null; a++)i[a] && i[a].nodeType === 1 && c.push(h[a]); else c.push.apply(c, i); else v(i, c);
            if (j) {
                n(j, e, c, d);
                n.uniqueSort(c)
            }
            ...
            for (var e, f, h = a, i = [], j = b, k = b && b[0] && n.isXML(b[0]); a && b.length;) {
                for (var l in p.filter)if ((e = p.leftMatch[l].exec(a)) != null && e[2]) {
                    ...
                    if (q.substr(q.length - 1) !== "\\") {
                        ...
                        if (e)for (var s = 0; (q = j[s]) != null; s++)if (q) {
                            o = r(q, e, s, j);
                            var t = d ^ !!o;
                            if (c && o != null) t ? f = true : j[s] = false; else if (t) {
                                i.push(q);
                                f = true
                            }
                        }
                ...
                if (a === h)if (f == null) n.error(a); else break;
                h = a
            }
            return j
        };
        ...
        var p = n.selectors = {
            ...
            leftMatch: {}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {
                ...
                CLASS: function (a, b, c, d, e, f) {
                    a = " " + a[1].replace(G, "") + " ";
                    if (f)return a;
                    for (var f = 0, h; (h = b[f]) != null; f++)h && (e ^ (h.className &&
                    ...
                    if (a[1] === "not")if ((ra.exec(a[3]) || "").length > 1 || /^\w/.test(a[3])) a[3] = n(a[3], null, null, b); else {
                ...
                PSEUDO: function (a, b, c, d) {
                    ...
                    switch (c) {
                        ...
                        case "first":
                            for (; d =
                                       d.previousSibling;)if (d.nodeType === 1)return false;
        ...
        try {
            ...
            v =
                function (a, b) {
                    var c = 0, d = b || [];
                    if (Ya.call(a) === "[object Array]") Array.prototype.push.apply(d, a); else if (typeof a.length === "number")for (var e = a.length; c < e; c++)d.push(a[c]); else for (; a[c]; c++)d.push(a[c]);
                    return d
                }
        }
        var ca, N;
                ...
                if (d.isArray(a)) {
                    ...
                    if (f &&
                        ...
                        for (; f && f.ownerDocument && f !== b;) {
                            for (h in i) {
                                g = i[h];
                                (g.jquery ? g.index(f) > -1 : d(f).is(g)) && c.push({selector: h, elem: f, level: j})
                            }
                            f = f.parentNode;
                            j++
                        }
        ...
        d.fn.extend({
            text: function (a) {
                ...
                for (var c = 0, g; (g = this[c]) != null; c++)if (!a || d.filter(a, [g]).length) {
                    if (!b && g.nodeType === 1) {
            ...
            empty: function () {
                ...
                if (this[0]) {
                    g = h && h.parentNode;
                    g = d.support.parentNode && g && g.nodeType === 11 && g.childNodes.length === this.length ? {fragment: g} : d.buildFragment(a, this, i);
                    f = g.fragment;
            ...
            clone: function (a, b, c) {
                ...
                for (var e = [], f, h = 0, i; (i = a[h]) != null; h++) {
                    ...
                    if (i) {
                        ...
                        var n;
                        if (!d.support.appendChecked)if (i[0] &&
                            typeof(n = i.length) === "number")for (f = 0; f < n; f++)Fa(i[f]); else Fa(i);
                ...
                if (c) {
                    ...
                    for (h = 0; e[h]; h++)if (g && d.nodeName(e[h], "script") && (!e[h].type || e[h].type.toLowerCase() === "text/javascript")) g.push(e[h].parentNode ? e[h].parentNode.removeChild(e[h]) : e[h]); else {
                        if (e[h].nodeType === 1) {
                ...
                for (var b, c,
                         g = d.cache, e = d.expando, f = d.event.special, h = d.support.deleteExpando, i = 0, j; (j = a[i]) != null; i++)if (!j.nodeName || !d.noData[j.nodeName.toLowerCase()])if (c = j[d.expando]) {
    ...
    var optimizelyCode = function () {
        var DATA = {
            ...
            "goal_expressions": {
                "3522830018": ["^robocall\\_landing\\-\\_bottom\\_social\\_shares$"],
                "3520500037": ["^robocalls\\_\\-\\_landing\\_\\-\\_petition\\_clickthrough$"],
                "3783040458": ["^shared\\_story$"],
                "3511520015": ["^robocalls\\_\\-\\_landing\\_\\-\\_donate\\_clickthrough$"],
                "3477711029": ["^engagement$"],
                "3859445310": ["^smb\\_\\-\\_conversion$"]
            },
            "experiments": {
                "3764770516": {
                    "variation_weights": {"3759661892": 5000, "3732342505": 5000},
                    "name": "Robocalls - CR Branding - Production",
                    "enabled": true,
                    "variation_ids": ["3759661892", "3732342505"],
                    "urls": [{"match": "simple", "value": "http://consumersunion.org/end-robocalls"}],
                    "enabled_variation_ids": ["3759661892", "3732342505"]
                },
                "3786840452": {
                    "variation_weights": {"3765021882": 5000, "3785770493": 5000},
                    "name": "Robocalls - Share Your Story - show/hide latest Story",
                    "enabled": true,
                    "variation_ids": ["3765021882", "3785770493"],
                    "urls": [{
                        "match": "simple",
                        "value": "https://consumersunion.org/end-robocalls/share-your-robocall-story/"
                    }],
                    "enabled_variation_ids": ["3765021882", "3785770493"]
                },
                "3735223540": {
                    "audiences": [3539280012],
                    "name": "Robocalls - Landing - remove navigation bar",
                    "variation_ids": ["3712757464", "3732204446"],
                    "urls": [{"match": "simple", "value": "http://consumersunion.org/end-robocalls/"}],
                    "enabled_variation_ids": ["3712757464", "3732204446"]
                },
                "3846280861": {
                    "audiences": [3539280012],
                    "variation_weights": {"3867930632": 5000, "3826610963": 5000},
                    "name": "Surprise Medical Bills - Petition Placement (now with moar goals)",
                    "enabled": true,
                    "variation_ids": ["3867930632", "3826610963"],
                    "urls": [{"match": "simple", "value": "https://consumersunion.org/surprise-medical-bills/"}],
                    "enabled_variation_ids": ["3867930632", "3826610963"]
                },
                "3558942879": {
                    "name": "Surprise Medical Bills - Petition Placement",
                    "variation_ids": ["3578601684", "3606020377"],
                    "urls": [{"match": "simple", "value": "https://consumersunion.org/surprise-medical-bills/"}],
                    "enabled_variation_ids": ["3578601684", "3606020377"]
                }
            },
            "audiences": {
                "3539280012": {
                    "conditions": ["and", ["or", ["or", {
                        "dimension_id": 3534070010,
                        "value": "desktop"
                    }]]], "name": "Desktop/Laptop Users"
                }
            },
            "www_host": "master-2658.optimizely-hrd.appspot.com",
            "public_suffixes": {"consumersunion.org": ["consumersunion.org", "beta.consumersunion.org"]},
            "force_variation": true,
            "dimensions": {"3534070010": {"condition_type": "device"}},
            "version": "master-2658.396641141550159952",
            "admin_account_id": 62715456,
            "blacklisted_experiments": [7256000895, 5759972257, 7122153314, 7137310563, 7115370630, 6136700839, 7087080040, 7338172009, 7015431275, 7360610465, 5965760029, 7131630479, 6668040048, 7098831091, 7472490388, 6994162678, 6653000057, 4851843497, 4884030013, 6127735316],
            "project_id": 3475070035,
            "revision": 59,
            "summary_revenue_goal_id": 3483890970,
            "installation_verified": true,
            "preview_host": "//optimizely.s3.amazonaws.com",
            "api_host": "api.optimizely.com",
            "variations": {
                "3759661892": {"name": "Original"},
                "3867930632": {"name": "Original"},
                "3732342505": {
                    "code": "$(\".logo\").css({\"background-image\":\"url(//cdn.optimizely.com/img/62715456/ab6c137fa6c64e36966aac1cc3d74711.png)\"});",
                    "name": "CR-branded"
                },
                "3826610963": {
                    "code": "$(\".img-responsive\").css({\"position\":\"relative\", \"left\":-388, \"top\":-18});\n$(\".pull-left\").css({\"left\":1036, \"top\":50});\n$(\"#map\").css({\"position\":\"relative\", \"left\":-14, \"top\":-45});\n$(\"#map\").css({\"left\":-16, \"top\":-2});",
                    "name": "Petition Right"
                },
                "3578601684": {"name": "Original"},
                "3712757464": {"name": "Original"},
                "3606020377": {
                    "code": "$(\".pull-left\").css({\"left\":1064, \"top\":56});\n$(\".img-responsive\").css({\"position\":\"relative\", \"left\":-388, \"top\":-18});\n$(\".pull-left\").css({\"left\":1036, \"top\":50});",
                    "name": "Variation #1"
                },
                "3765021882": {"name": "Original"},
                "3785770493": {
                    "code": "$(\"#stori_es-collection-796096\").css({\"display\":\"none\", \"visibility\":\"\"});\n$(\".sub-title\").html(\"Your story can move mountains - or in this case, phone companies. How have the endless robocalls harmed you?\");",
                    "name": "Without Story"
                },
                "3732204446": {
                    "code": "$(\".topnav\").css({\"top\":\"674px\"});\n$(\".topnav\").css({\"display\":\"none\", \"visibility\":\"\"});\n$(\".banner2\").css({\"position\":\"relative\", \"top\":46});",
                    "name": "Variation #1"
                }
            },
            "segments": {
            ...
            "click_goals": [{
                "event_name": "robocalls_-_landing_-_donate_clickthrough",
                "experiments": {"3684800017": true, "3687930875": true, "3506970060": true},
                "selector": ".robo-menu-buttons > a:eq(1)"
            }, {
                "event_name": "robocalls_-_landing_-_petition_clickthrough",
                "experiments": {
                    "3684800017": true,
                    "3506970060": true,
                    "3687930875": true,
                ...
                "selector": ".pull-right .btn"
            }, {
                "event_name": "robocall_landing-_bottom_social_shares",
                "experiments": {"3684800017": true, "3687930875": true, "3506970060": true},
                "selector": ".sp_15762 > a,.sp_15763 > a"
            }, {
                "event_name": "shared_story",
                "experiments": {"3786840452": true},
                "selector": "#stories-submit-button"
            }, {
                "event_name": "smb_-_conversion",
                "experiments": {"3846280861": true},
                "selector": ".visible-desktop #ACTION_SUBMIT_SURVEY_RESPONSE"
            }]
        };
        ...
        function vd(a, b, c) {
            ...
            Id();
            Zc();
            B && !c.za && Jd(document.location.href, "pageview", {hb: j})
        }
        ...
        function zd(a) {
            ...
            var b = [], c = [], d = [], e = [];
            w(a, function (a) {
                cc(a, "is_api_only") ? (M("Activator", "Ignoring API-only segment " + a), e.push(a)) : Cd(a) ? Dd(a, {objectType: "segment"}) ? (M("Activator", "Passed conditions for segment " + a), b.push(a)) : (M("Activator", "Failed conditions for segment " + a), d.push(a)) : (M("Activator", "Can't test conditions for segment " + a), c.push(a))
            });
            w(c, Kd);
            Ld(b);
            Ld(d);
        ...
        function Td(a, b) {
            for (var c in b)if ("object" === typeof b[c] && 0 < b[c].length)for (var d = 0; d < b[c].length; d++) {
        ...
        function Yd(a) {
            a = (a || "").toLowerCase();
            if (a in Zd)return a;
            for (var b in Zd)if (D(Zd[b] || [], function (b) {
        ...
        function ud(a, b, c) {
            Ra = j;
            B && c !== j && Jd(document.location.href, "pageview", {hb: j});
            ...
            }), d = d.join("_"); else if (!b && 1 == e.length && 256 >= Number(e[0])) {
        ...
        function af() {
            var a = document.location.href, b = z("pageview_revenue_goals");
            b && 0 < L(b) ? w(L(b), function (c) {
                    Jd(a, "pageview", {Q: c, T: b[c]})
                }) : Jd(a, "pageview")
        }
        ...
        function We() {
            ...
            w(Ue, function (a) {
                ...
                La && e.push("dtpc=" + La);
                var l = !!a.options && !!a.options.Q && a.options.T || {}, g = L(l), ze = K(Cb(), function (a) {
                    return !l[a]
                }), f = [{
                    U: g,
        ...
        lf.prototype.hash = function () {
            ...
            if (this[Y.f])for (var b = this[Y.f] || {}, c = K(L(b), function (a) {
        ...
        function mf(a, b) {
            ...
            var c = a[Y.f] || {}, d = b[Y.f] || {}, e = K(L(c), function (a) {
        ...
        function Gf(a, b) {
            ...
            if ("function" === typeof d) e = o, f = d; else try {
            ...
            if (e) {
                if (e = {objectType: "experiment", enabledStatus: b.enabledStatus}, b.force || !Cd(a) || Dd(a, e)) {
                    var n = function () {
                        Cd(a) && (Hf(0, {value: d}) || g) ? c() : setTimeout(n, 50)
                    };
                    n();
        ...
        J(fg.prototype, {
            ia: kc, Ja: lc, Ra: rc, w: sc, u: function () {
                return {id: this.ia(), version: this.Ja(), mobileId: this.Ra()}
            }, La: function () {
                return this.j("utm_campaign")
            }, I: v, K: mc, W: Hc, la: function (a) {
                try {
                    return window[a]
                } catch (b) {
                    return k
        ...
        function og(a, b) {
            ...
            if (b.op) {
                ...
                if (c) {
                    var d = t(og, a), e = I(b.args || [], function (a) {
                        return d(a)
                    });
                    return c(e, a)
                }
        ...
        function rg(a, b) {
            ...
            if (a.hasOwnProperty("select"))var Ta = a.select, c = I(c, function (a) {
        ...
        tg.prototype.fb = function () {
            w(this.p, p(function (a) {
                vg(this, a, o, {O: !!this.A.hasOwnProperty(a)})
            }, this))
        };
        function wg(a, b, c, d) {
            d = !H(d) || d;
        ...
        function Kg(a, b) {
            if (!b)return 0;
            for (var c = b.toString().split("."), d = a.toString().split("."), e = 0; e < c.length; e++)if (H(d[e])) {
        ...
        var Ig = {
            browser: function (a) {
                ...
                return D(a.values, function (a) {
                    return Pg(Z.ja(a.key), {value: a.value})
                })
            }, event: function (a) {
                return D(a.values, function (a) {
                    return Z.Aa(a)
                ...
                return 0 === a.values.length ? j : D(a.values, function (a) {
                        return Vg(Z.j(a.key), {value: a.value})
                    })
            }, referrer: function (a) {
            ...
            }, url: Zg, visitor: function (a) {
                var b = Z.na();
                return $g(b, a)
            }
        }, ah = {
            browser: Lg, browser_version: function (a, b) {
                var c =
            ...
            }, code: Hf, cookies: Ng, custom_dimension: function (a, b) {
                var c = b.value;
                return !H(c) ? H(a) : c == a
            }, custom_tag: Pg, default_behavior: function (a, b) {
                try {
            ...
            }, event: aa(), first_session: aa(), ip: Qg, language: Tg, list: function (a, b) {
                if (a === k || !H(a))return o;
                var c = b.value;
                return !H(c) ? "" === a || a !== o : a.toString() === c
            }, location: Ug, query: Vg, platform: function (a, b) {
            ...
            }, referrer: Wg, segment: Yg, source_type: function (a, b) {
                return b.value === a
            ...
            }, url: Jg, visitor: $g, dynamic_customer_profile: function (a, b) {
        ...
        function lh(a, b) {
            if (a && b)if (mh) M("Evaluator", "Bound event " + b + " to selector " + a), nh(a, b); else {
                var c = {eventName: b, selector: a, type: "event '" + b + "' (click goal)", waitUntilSelectorReady: j};
        ...
        function Jh() {
            if (!Da) {
                ...
                a.each = function (c, d, e) {
                    if (!(c.length === i || a.isFunction(c)) || !Ih()) b.apply(this, arguments); else if (e)for (var f in c) {
                        if (c.hasOwnProperty(f) && d.apply(c[f], e) === o)break
                    } else for (f in c)if (c.hasOwnProperty(f) && !d.call(c[f], f, c[f]) === o)break;
                    return c
                };
                var c = a.fn.$a, d = function (a, b, d) {
                    return new c(a, b, d)
            ...
            if (Ka) M("Main", "Disabling because in desktop app editor."); else if (Ja) M("Main", "Disabling because personalization editor flag is set."), db("https://" + Zb() + "/js/innie.js?_=" + +new Date); else if (he(), hf()) M("Main", "Disabling because opted out"),
                ...
                if (z("uses_list_targeting")) {
                    var f = "https://odds.optimizely.com/js/geo2.js", r = {};
                    w(Qb(), function (a, b) {
                        var c = Nc(b);
