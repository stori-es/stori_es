...
<div id="body" class="container">
    <div id="home">
        <div id="home-content">
            ...
            <div>
                Click the button below to unsubscribe from notifications about the addition of content to the stori.es
                collection "<%= request.getAttribute("collectionTitle") %>".
            </div>
            <% // the controller guarantees we have these parametres %>
            <a href="storiesunsubscription?collection=<%= request.getParameter("collection") %>&profile=<%= request.getParameter("profile") %>&confirmed=1">Unsubscribe</a>
            <a class="secondary" href="<%= context %>/signin.jsp">Cancel</a>
        </div>
        <div class="clear"></div>
        <footer>
