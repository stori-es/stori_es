...
public class AuthorizationServiceTest extends GWTTestCaseExposed {
    ...
    private void noAuthAccessGrant() {
        ...
        userService.logout(new AsyncFail<ActionResponse>(AuthorizationServiceTest.this, "noAuthAccessGrant:logout") {
            @Override
            public void onSuccess(ActionResponse result) {
                authService.grant(1053, ROLE_READER, 44,
                        new AsyncFail<ActionResponse>(AuthorizationServiceTest.this,
    ...
    private void noAuthAccessDeny() {
        ...
        userService.logout(new AsyncFail<ActionResponse>(AuthorizationServiceTest.this, "noAuthAccessDeny:logout") {
            @Override
            public void onSuccess(ActionResponse result) {
                authService.deny(1053, ROLE_READER, 44, new AsyncFail<ActionResponse>(AuthorizationServiceTest.this,
    ...
    private void denyAccessGrant() {
        ...
        userService.login("test", "password", new AsyncFail<DatumResponse<User>>(AuthorizationServiceTest.this,
                "denyAccessGrant:login") {
            @Override
            public void onSuccess(DatumResponse<User> result) {
                authService.grant(1053, ROLE_READER, 44, new AsyncFail<ActionResponse>(AuthorizationServiceTest.this,
    ...
    private void grantAccess() {
        ...
        userService.login("root", "password", new AsyncFail<DatumResponse<User>>(AuthorizationServiceTest.this,
                "grantAccess:login") {
            @Override
            public void onSuccess(DatumResponse<User> result) {
                final int SID = 1053;
                ...
                authService.isAuthorized(SID, ROLE_READER, 44, new AsyncFail<AuthorizationResponse>(
                        AuthorizationServiceTest.this, "grantAccess:isAuthorized") {
                    @Override
                    public void onSuccess(AuthorizationResponse result) {
                        ...
                        authService.grant(SID, ROLE_READER, 44, new AsyncFail<ActionResponse>(
                                AuthorizationServiceTest.this, "grantAccess:grant") {
                            @Override
                            public void onSuccess(ActionResponse result) {
                                assertFalse("Unexpeted error.", result.isError());
                                authService.isAuthorized(SID, ROLE_READER, 44, new AsyncFail<AuthorizationResponse>(
                                    ...
                                    public void onSuccess(AuthorizationResponse result) {
                                        ...
                                        authService.deny(SID, ROLE_READER, 44, new AsyncFail<ActionResponse>(
                                                AuthorizationServiceTest.this, "grantAccess:deny") {
                                            @Override
                                            public void onSuccess(ActionResponse result) {
                                                assertFalse("Unexpeted error.", result.isError());
                                                // and verify it
    ...
    private void getValidPrincipalsNoAuthentication() {
        ...
        userService.logout(new AsyncFail<ActionResponse>(AuthorizationServiceTest.this,
            ...
            public void onSuccess(ActionResponse result) {
                ...
                authService.getValidPrincipals(ROLE_READER, 4, new AsyncFail<DatumResponse<List<SystemEntity>>>(
                        AuthorizationServiceTest.this, "getValidPrincipalsNoAuthenticaiton:getValidPrincipals") {
                    @Override
    ...
    private void getValidPrincipalsNoAuthorization() {
        ...
        userService.login("testUser", "password", new AsyncFail<DatumResponse<User>>(AuthorizationServiceTest.this,
            ...
            public void onSuccess(DatumResponse<User> result) {
                ...
                authService.getValidPrincipals(ROLE_READER, 1061, new AsyncFail<DatumResponse<List<SystemEntity>>>(
                        AuthorizationServiceTest.this, "getValidPrincipalsNoAuthorization:getValidPrincipals") {
                    @Override
                    public void onSuccess(DatumResponse<List<SystemEntity>> result) {
    ...
    private void getValidPrincipalsAuthorized() {
        ...
        userService.login("aclUser1", "password", new AsyncFail<DatumResponse<User>>(AuthorizationServiceTest.this,
                "getValidPrincipalsAuthorized:login") {
            @Override
            public void onSuccess(DatumResponse<User> result) {
                assertFalse("Unexpeted errors.", result.isError());
                authService.getValidPrincipals(ROLE_READER, 4, new AsyncFail<DatumResponse<List<SystemEntity>>>(
                        AuthorizationServiceTest.this, "getValidPrincipalsAuthorized:getValidPrincipals") {
                    @Override
                    public void onSuccess(DatumResponse<List<SystemEntity>> result) {
    ...
    private void getValidPrincipalsSuperUser() {
        ...
        userService.login("root", "password", new AsyncFail<DatumResponse<User>>(AuthorizationServiceTest.this,
            ...
            public void onSuccess(DatumResponse<User> result) {
                assertFalse("Unexpeted errors.", result.isError());
                authService.getValidPrincipals(ROLE_READER, 4, new AsyncFail<DatumResponse<List<SystemEntity>>>(
                        AuthorizationServiceTest.this, "getValidPrincipalsSuperUser:getValidPrincipals") {
                    @Override
                    public void onSuccess(DatumResponse<List<SystemEntity>> result) {
                        assertFalse("Unexpected errors.", result.isError());
                        assertEquals("Unexpected principal count.", 2, result.getDatum().size());
        ...
        userService.logout(new AsyncFail<ActionResponse>(AuthorizationServiceTest.this,
            ...
            public void onSuccess(ActionResponse result) {
                ...
                authService.getValidTargets(38, ROLE_READER, new AsyncFail<DatumResponse<List<SystemEntity>>>(
                        AuthorizationServiceTest.this, "getValidTargetsNoAuthentiaciton:getValidTargets") {
                    @Override
                    public void onSuccess(DatumResponse<List<SystemEntity>> result) {
                        assertEquals("Unexpected error message count", 1, result.getGlobalErrorMessages().size());
                        assertEquals("Unexpected result.", NOT_LOGGED_IN, result.getGlobalErrorMessages().get(0));
    ...
    private void getValidTargetsNoAuthorization() {
        ...
        // User ID=30
        userService.login("dryan", "password", new AsyncFail<DatumResponse<User>>(AuthorizationServiceTest.this,
            ...
            public void onSuccess(DatumResponse<User> result) {
                ...
                authService.getValidTargets(1038, ROLE_READER, new AsyncFail<DatumResponse<List<SystemEntity>>>(
                        AuthorizationServiceTest.this, "getValidTargetsNoAuthorization:getValidTargets") {
                    @Override
                    public void onSuccess(DatumResponse<List<SystemEntity>> result) {
                        assertEquals("Unexpected message count.", 1, result.getGlobalErrorMessages().size());
        ...
        userService.login("testUser", "password", new AsyncFail<DatumResponse<User>>(AuthorizationServiceTest.this,
            ...
            public void onSuccess(DatumResponse<User> result) {
                ...
                authService.getValidTargets(1001, ROLE_READER, new AsyncFail<DatumResponse<List<SystemEntity>>>(
                        AuthorizationServiceTest.this, "getValidTargetsAuthorized:getValidTargets") {
                    @Override
                    public void onSuccess(DatumResponse<List<SystemEntity>> result) {
                        assertFalse("Unexpected errors.", result.isError());
            ...
            public void onSuccess(DatumResponse<User> result) {
                ...
                authService.getValidTargets(1001, ROLE_READER, "collection",
                        new AsyncFail<DatumResponse<List<SystemEntity>>>(
                                AuthorizationServiceTest.this, "getValidTargetsSuperUser:getValidTargets") {
                            @Override
                            public void onSuccess(DatumResponse<List<SystemEntity>> result) {
                                assertFalse("Unexpected errors.", result.isError());
                                assertEquals("Unexpected principal count.", 9, result.getDatum().size());

                                // now check that root asking about root. Root *can* read anything, but it's not
                                // through grants
